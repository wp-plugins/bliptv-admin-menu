...
if (!class_exists('blipPHP')) {
    ...
    class blipPHP {
       ...
       *
       * @param string[required] $user	- Blip.tv username
       * @param int[optional]    $page	- results page number
       * @return Response stdClass if succes, or FALSE if there error.
       */
      public function usersFiles($user=null,$page='1') {
        if(($user==null) or (empty($user)))
          throw new Exception("MISSING_PARAMETER: No username given.");
